...
@allure.description("When the user encounters an error message during the login process, they should be able to close the message and try again. This test verifies that the error message can be closed.")
